// Write a javascript function, which takes 2 arguments, 1st an array of products and the second argument the id of the product
// Test Case: 
...
function findProduct(products, id) {
    var filteredProducts = products.find(product => product.id == id);
    if(filteredProducts)
