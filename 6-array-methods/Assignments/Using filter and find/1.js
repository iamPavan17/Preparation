// Write a JavaScript function that takes 2 arguments, an array of products and a category name, the function should return all the products that belong to the given category 
...
function findByCategory(products, categoryName) {
